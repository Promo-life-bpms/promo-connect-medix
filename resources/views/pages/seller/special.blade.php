    ...
    <div class="mx-auto">
                            ...
                            <form action="{{ route('specialStorage') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" name="image_reference" id="image_reference" class="w-full p-2 border rounded-md" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="file" class="block text-gray-700 text-sm font-bold mb-2">Archivo</label>
                                        <input type="file" name="file" id="file" class="w-full p-2 border rounded-md" required>
                                    </div>

                                </div>

                                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <button data-modal-hide="default-modal" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Aceptar</button>
        ...
        <div class="w-full m-6">
            ...
            @else
                ...
                <table class="m-20" style="width:90%;">

                    <thead>
                        <tr>
                            <th style="width: 10%;">#</th>
                            <th style="width: 40%;">Descripción</th>
                            <th style="width: 20%;">Imagen de referencia</th>
